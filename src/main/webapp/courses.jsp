    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
      <div class="container">
        <div class="row align-items-end">
          <div class="col-lg-7">
            <h2 class="mb-0"><fmt:message key="header.faculty"/></h2>
          </div>
        </div>
      </div>
    </div> 
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="course-1-item">
              ...
              <div class="course-1-content pb-4">
                ...
                <p><a href="course-single3.jsp" class="btn btn-primary rounded-0 px-4"><fmt:message key="home.transition"/></a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="course-1-item">
              <figure class="thumnail">
                <a href="course-single5.jsp"><img src="images/course_5.jpg" alt="Image" class="img-fluid"></a>
