...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
      <div class="container">
        <div class="row align-items-end">
          <div class="col-lg-7">
            <h2 class="mb-0"><fmt:message key="header.about"/></h2>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        <a href="#"><fmt:message key="header.home"/></a>
        <span class="mx-3 icon-keyboard_arrow_right"></span>
        <span class="current"><fmt:message key="header.about"/></span>
      </div>
    </div>
    ...
    <div class="container pt-5 mb-5">
      <div class="row">
        ...
        <div class="col-lg-4">
          <p><fmt:message key="about.historyUniversity"/></p>
        </div>
        <div class="col-lg-4">
          <p><fmt:message key="about.historyBuilding"/></p>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 mr-auto align-self-center order-2 order-lg-1">
            ...
            <p><fmt:message key="about.managementFaculty"/></p>
          </div>
        </div>
      </div>
    </div>
