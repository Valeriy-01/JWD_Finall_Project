  ...
  <div class="site-wrap">
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current"><fmt:message key="header.news"/></span>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-9 mb-4">
            ...
            <p><fmt:message key="news.description_1"/></p>
            <p><fmt:message key="news.description_2"/></p>
            <p><fmt:message key="news.description_3"/></p>
            <p><fmt:message key="news.description_4"/></p>
            <p><fmt:message key="news.description_5"/></p>
          </div>
