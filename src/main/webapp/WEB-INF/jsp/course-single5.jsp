...
<body>
	...
	<div class="custom-breadcrumns border-bottom">
		<div class="container">
			...
			<a href="Controller?command=gotofacultypage"><fmt:message
					key="header.faculty" /></a> <span
				class="mx-3 icon-keyboard_arrow_right"></span> <span class="current"><fmt:message
					key="home.infocommunications" /></span>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 ml-auto align-self-center">
					...
					<p>
						<fmt:message key="courseSingle_5.technologies" />
					</p>
					<p>
						<fmt:message key="courseSingle_5.successfully" />
					</p>
