		...
		<div class="custom-breadcrumns border-bottom">
			<div class="container">
				<a href="index.jsp"><fmt:message key="header.home" /></a> <span
					...
					class="current"><fmt:message key="list.title" /></span>
			</div>
		</div>

		<table class="table table-striped table-bordered table-hover"
			style="margin: 2% 3% 2% 2%">
			<thead>
				<tr>
					<th style="max-width: 10px"><fmt:message key="user.id" /></th>
					<th style="max-width: 50px"><fmt:message key="user.faculty" /></th>
					<th style="max-width: 40px"><fmt:message key="user.surname" /></th>
					<th style="max-width: 30px"><fmt:message key="user.name" /></th>
					<th style="max-width: 30px"><fmt:message key="user.total" /></th>
					<th style="max-width: 40px"><fmt:message key="user.email" /></th>
				</tr>
			</thead>
			<tbody>
				<c:forEach var="user" items="${sessionScope.users}">
					<tr>
						...
						<td><c:out value="${user.totalScope}" /></td>
