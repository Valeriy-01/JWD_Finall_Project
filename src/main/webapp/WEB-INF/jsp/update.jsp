...
<c:set var="oldPaspport" value="${param.passport}" scope="session" />
				...
				<div class="row align-items-center">
					<div class="col-lg-9 d-none d-lg-block">
						<a href="#" class="small mr-3"><span
							class="icon-question-circle-o mr-2"></span>
						<fmt:message key="header.question" /></a> <a href="#"
							class="small mr-3"><span class="icon-phone2 mr-2"></span>
						<fmt:message key="header.phone" /></a> <a href="#" class="small mr-3"><span
							class="icon-envelope-o mr-2"></span>
						<fmt:message key="header.email" /></a>
					</div>
					<div class="col-lg-3 text-right">
						<a href="Controller?command=gotologinpage" class="small mr-3"><span
							class="icon-unlock-alt"></span>
						<fmt:message key="header.login" /></a> <a
							href="Controller?command=gotoregisterpage"
		...
		<div class="custom-breadcrumns border-bottom">
			<div class="container">
				<a href="index.jsp"><fmt:message key="header.home" /></a> <span
					...
					class="current"><fmt:message key="header.update" /></span>
			</div>
		</div>
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-md-5">
							<div class="row">
								...
								<div class="col-md-12 form-group">
									<label for="faculty"><b><fmt:message
										...
										name="faculty" class="form-control form-control-lg"
										value="${sessionScope.faculty}" required>
										<option><fmt:message key="home.networks" /></option>
										<option><fmt:message key="home.design" /></option>
										<option><fmt:message key="home.management" /></option>
										<option><fmt:message key="home.electronics" /></option>
										<option><fmt:message key="home.infocommunications" /></option>
										<option><fmt:message key="home.economics" /></option>
									</select>
								</div>
								<div class="col-md-12 form-group">
									<label for="maths"><b><fmt:message
												key="register.sub_1" /></b></label> <input type="text" id="maths"
										name="sub_1" class="form-control form-control-lg"
										value="${sessionScope.maths}" required
										pattern="(100)|([0-9]{1,2}(\.[0-9]+)?)">
								</div>
								<div class="col-md-12 form-group">
									<label for="physics"><b><fmt:message
												key="register.sub_2" /></b></label> <input type="text" id="physics"
										name="sub_2" class="form-control form-control-lg"
										value="${sessionScope.physics}" required
										pattern="(100)|([0-9]{1,2}(\.[0-9]+)?)">
								</div>
								<div class="col-md-12 form-group">
									<label for="russian"><b><fmt:message
												key="register.sub_3" /></b></label> <input type="text" id="russian"
										name="sub_3" class="form-control form-control-lg"
										value="${sessionScope.russian}" required
										pattern="(100)|([0-9]{1,2}(\.[0-9]+)?)">
								</div>
								<div class="col-md-12 form-group">
									<label for="certificate"><b><fmt:message
										...
										value="${sessionScope.certificate}" required
										pattern="(100)|([0-9]{1,2}(\.[0-9]+)?)">
								</div>
								<div class="col-md-12 form-group">
							...
							<div class="row">
								<div class="col-12">
									<button type="submit" name="oldPassport"
										value="${sessionScope.oldPassport}"
